...
namespace Business
{
    public class User
    {
        ...
        public void PostActivity(string userAccountLoggedId, string userOfUserAccountLoggedId, string category, string contentsType)
        {
            new Database.User().PostUserActivity(userAccountLoggedId, userOfUserAccountLoggedId, category, contentsType);
        }
